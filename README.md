...
This will display in addition a percent number. The first number is the chance to survive on actual segment, the second number is the chance to survive to the end. It considers the settings "Use most recent" and "Consider at least".
